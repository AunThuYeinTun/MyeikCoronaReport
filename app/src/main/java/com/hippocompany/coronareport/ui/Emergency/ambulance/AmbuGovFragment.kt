...
class AmbuGovFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.ambulance_fragment_layout, container, false)
       ...
       toolbar=root.findViewById(R.id.ambutoolbar)
  /*
        ...
        toolbar.setNavigationOnClickListener{
            ...
            val ambuconstraintLayout:ConstraintLayout=root.findViewById(R.id.ambu_container)
        ...
        list=root.findViewById(R.id.ambulist)
        val recyclerViewAdapter: AmbuRecyclerViewAdapter = AmbuRecyclerViewAdapter()
        list.hasFixedSize()
        recyclerViewAdapter.notifyDataSetChanged()
        list.adapter=AmbuRecyclerViewAdapter()
