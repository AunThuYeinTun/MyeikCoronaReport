...
class OrgnizationFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.org_fragment_layout, container, false)
        ...
        toolbar=root.findViewById(R.id.orgtoolbar)
        ...
        toolbar.setNavigationOnClickListener{
            ...
            val orgconstraintLayout:ConstraintLayout=root.findViewById(R.id.org_container)
        ...
        list=root.findViewById(R.id.orglist)
        val recyclerViewAdapter: OrgRecyclerViewAdapter = OrgRecyclerViewAdapter()
        list.hasFixedSize()
        recyclerViewAdapter.notifyDataSetChanged()
        list.adapter=OrgRecyclerViewAdapter()
